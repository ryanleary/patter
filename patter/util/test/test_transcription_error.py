...
class TestTranscriptionError(unittest.TestCase):
    def test_simple_error_calculation(self):
        ...
        self.assertEqual(err.cer, 3/13, "Character Error Rate is incorrect")
    ...
    def test_combined_error_calculation(self):
        ...
        self.assertEqual(err1.wer, 1/3, "Word Error Rate is incorrect")
        ...
        self.assertEqual(err2.wer, 1/8, "Word Error Rate is incorrect")

        err3 = err1 + err2
        self.assertEqual(err3.wer, 2/11, "Combined word error rate is incorrect")
        self.assertEqual(err1.wer, 1/3, "Word Error Rate is incorrect")
        self.assertEqual(err2.wer, 1/8, "Word Error Rate is incorrect")
